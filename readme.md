# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/Wasif20/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/Wasif20/spring-petclinic/actions/workflows/maven.yml)
